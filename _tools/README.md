...
- **244 pytest зелёных, 0 skipped** (+10 DS-нефтегаз; +9 DS-химия; +EDA-параметризация и DS-синтез).
...
```bash
cd _tools
python -m pytest tests/ -v              # 244 зелёных, 0 skipped
```
...
| **D (частично)** | Расширение тестов — 244 зелёных (0 skipped) |
