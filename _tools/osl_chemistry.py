...
PRICES = {
    ...
    "avg_phosphate_company": FertilizerPrice(
        "avg_phosphate_company", 543, source="ФосАгро 9М 2025: 441.7/9.15 млн т ÷ 89"
    ),
    "avg_nitrogen_company": FertilizerPrice(
        "avg_nitrogen_company", 297, source="Акрон 12М 2025: 237.6/8.98 млн т ÷ 89"
    ),
    "polymers_avg": FertilizerPrice(
        "polymers_avg",
        1_500,
        source="value-added полимеры СИБУР: ПЭТ/ПВД/БК + внутр. премия + торговые операции",
    ),
}
...
ACRON_PRODUCTION = [
    FertilizerProduction(
        "Акрон", "avg_nitrogen_company", 8_983, "12M2025", "12М факт по операционным данным +7% г/г"
    ),
]
...
URALCHEM_PRODUCTION = [
    FertilizerProduction(
        "Уралхим", "avg_nitrogen_company", 7_000, "12M2025", "оценочно по средне-нитрогеновой цене"
    ),
]
...
SIBUR_PRODUCTION = [
    FertilizerProduction(
        "СИБУР", "polymers_avg", 7_500, "12M2025", "все полимеры по средневзв. цене"
    ),
]
...
PROFILES = {
    "ФосАгро": CompanyProfile(
        name="ФосАгро",
        business_model="fertilizer_pure",
...
ACTUAL_REVENUE_2025 = {
    "ФосАгро": {
        "rub_bn": 590,
        "source": "9М 2025 = 441.7 млрд ₽ (+19.1%); 12М экстраполяция ≈ 590",
    },
    "Акрон": {
        "rub_bn": 237.6,
        "source": "МСФО 12М 2025 — 237.6 млрд ₽ (+19.92%); EBITDA 91.6 (+51%)",
    },
...
def predict_fertilizer(
    company: str,
    production: List[FertilizerProduction],
...
def main():
    ...
    print("=" * 70)
    print("  OSL Backtest — Химия 12М 2025")
