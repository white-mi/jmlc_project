...
PROFILES = {
    'ХМАО-Югра': RegionProfile(
        name='ХМАО-Югра', region_type='oil_donor',
    ...
    'Тюменская обл.': RegionProfile(
        name='Тюменская обл.', region_type='oil_donor',
    ...
    'ЯНАО': RegionProfile(
        name='ЯНАО', region_type='gas_donor',
    ...
    'Татарстан': RegionProfile(
        name='Татарстан', region_type='oil_donor',
    ...
    'Сахалинская обл.': RegionProfile(
        name='Сахалинская обл.', region_type='oil_donor',
