"""
osl_common — общие структуры для всех OSL-модулей.

`RevenuePredict` и `FXRate` определены здесь один раз для всех 7 osl_*.py, чтобы
правка схемы не требовала 7 синхронных изменений. Структура — единый суперсет:
