...
│  ├── _tools/                                                │
│  │   ├── osl_*.py          (7 models: 5 validated/2 illustr)│
...
- **Характер:** персональная конкурсная работа; только публичные/иллюстративные данные (клиентских/портфельных данных банка — ноль).
- **Bug reports / вопросы:** через GitHub Issues.
