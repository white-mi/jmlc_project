...
> **← Хаб** · [← Макро-знания](1_Macro_Knowledge_for_IT.md) · [→ User Guide](3_User_Guide_Analyst.md) · [→ Тех. документация](4_Tech_Architecture.md)

Обзор технологий, паттернов и подходов, применённых в проекте «Russian Propagation». Документ для разработчика, который собирается работать с кодом или расширять систему.
